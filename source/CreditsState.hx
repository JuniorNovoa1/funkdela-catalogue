...
class CreditsState extends MusicBeatState
{
	...
	var backgroundSTATIC:FlxSprite;
	...
	override function create()
	{
		...
		backgroundSTATIC = new FlxSprite(0, 0);
		backgroundSTATIC.frames = Paths.getSparrowAtlas('optwaves');
		backgroundSTATIC.antialiasing = ClientPrefs.globalAntialiasing;
		backgroundSTATIC.animation.addByPrefix('idle', 'idle0', 24, true);
		backgroundSTATIC.animation.play('idle');
		backgroundSTATIC.scale.set(3, 3);
		backgroundSTATIC.updateHitbox();
		backgroundSTATIC.screenCenter();
		...
		var pisspoop:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			...
			['Case',			    'case',		        'Musician',						                            'https://twitter.com/xhitest',		    'C30085'],
			['BreezyMelee',		    'jay',			    'Vol. 0/1 Programmer',					                    'https://twitter.com/BreezyMelee',			'279ADC'],
			['JayyThunder',		    'breezy',			'Artist / Animator',					                    'https://twitter.com/ThunderJayy',			'279ADC'],
			['Murasaki',		    'mura',			    'Vol. 0/1 Programmer',					                    'https://twitter.com/Murasaki_1514',			'279ADC'],
			['ItoSaihara',		    'ito',			    'Vol. 0 Logo and Emotional Support',					    'https://twitter.com/ItoSaihara_',			'279ADC'],
			...
			['Ryk',			        'ryk',			    'VCR Distortion Shader',							        'https://www.shadertoy.com/user/ryk',			'389A58'],
		];
