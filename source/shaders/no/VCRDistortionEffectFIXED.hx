...
class VCRDistortionEffectFIXED
{
  public var shader:VCRDistortionShaderFIX = new VCRDistortionShaderFIX();
  public function new(){
    ...
    var noise = Assets.getBitmapData('assets/images/noise2.png');
...
class VCRDistortionShaderFIX extends FlxFixedShader
{
